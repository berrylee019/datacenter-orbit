...
with form_col2:
    input_target = st.selectbox("우선 관제 희망 타깃", [
        ...
        "MS-블랙록 버지니아 허브", "미시간 팰리세이드 SMR", "하남 데이터센터", "구글 세인트 토마스 AIDC", "메타 인디애나 AI 클러스터", "MS-오픈AI 스타게이트 (비밀기지 예정지)", "해남 솔라시도 데이터센터 파크", "카카오 데이터센터 안산 (AIDC 고도화 라인)", "테라파워 와이오밍 케머러 SMR 기지"
